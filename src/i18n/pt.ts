export default {
    title: "JamCam 2025 - América Unida pela Paz | Cali, Colombia",
    description: "Cali será o epicentro do escultismo com o JamCam 2025, de 26 de dezembro de 2025 a 2 de janeiro de 2026. Milhares de jovens Escoteiros da América se unirão em prol da paz, da fraternidade e da aventura",
    header: {
    ...
    footer: {
        ...
        designed: "Projetado por",
        developed: "Desenvolvido por",
    },
    resources: {
        brandManual: "Manual de marca",
        poolRules: "Normas de uso das piscinas Comfandi",
        epidemiologicalRecommendations: "Recomendações sanitárias e epidemiológicas",
    },
    soundtrack: {
        pageTitle: "Soundtrack JAMCAM 2025",
        description: "Baixe as músicas oficiais do JAMCAM 2025",
        downloadSong: "Baixar música",
        officialAnthem: "Hino Oficial",
        anthemSubtitle: "Hino do JamCam 2025",
    ...
    infoCards: {
        ...
        cards: {
            explore: {
                ...
                description: "Mergulhe na aventura do JamCam 2025. Este é o momento de abrir os olhos para novas experiências, aprender sobre outras culturas e se conectar com a natureza. Explore o que está ao seu redor, faça novos amigos e se prepare para dias cheios de emoção e aprendizado."
            },
            share: {
                title: "Compartilhe e construa",
                description: "Cada história, cada ideia e cada ação podem fazer a diferença. Compartilhe o que você sabe, aprenda com os outros e trabalhe em equipe para criar momentos inesquecíveis. Juntos, construiremos um ambiente de respeito, solidariedade e crescimento."
            },
            transform: {
                title: "Transforme e deixe sua marca",
    ...
    calendar: {
        ...
        events: {
            "2025-04-30": [
                "Prazo limite para confirmação de contingentes",
                "Prazo limite para o pagamento de inscrição antecipada"
            ],
            "2025-06-28": [
                "Reunião presencial de Chefes de Contingentes"
            ],
            "2025-08-30": [
                "Prazo limite para o pagamento da inscrição regular"
            ],
            "2025-09-01": [
                "Publicação - Boletim 3"
            ],
            "2025-09-30": [
                "Prazo limite para o pagamento de inscrição tardia"
            ],
            "2025-12-26": [
                "Ingresso de membros EIS e CMT ao local do JamCam 2025"
            ],
            "2025-12-27": [
                "Ingresso de participantes ao local do JamCam 2025"
            ],
            "2026-01-02": [
                "Saída dos participantes, EIS e CMT do local do JamCam 2025"
            ]
    ...
    consoleMessages: {
        greeting: "Ei, o que você está fazendo aqui!",
        cholaoWatching: "Cholao está te observando!",
        areDeveloper: "Você é desenvolvedor?",
        checkRepo: "Venha e veja o repositório no GitHub!",
        giveStar: "Nos dê uma estrela no GitHub!",
        canBeScout: "Excelente! Você também pode ser Escoteiro",
        adventureAndCode: "Você gosta de aventura e código?",
        joinJamCam: "Junte-se ao JamCam 2025 em Cali!",
        dates: "De 26 de dezembro de 2025 a 2 de janeiro de 2026",
        youthAdventure: "Milhares de jovens, aventura e tecnologia!",
